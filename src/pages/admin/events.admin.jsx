...
//             {events.map(event => (
//                 <li key={event._id} className="col-span-1 flex flex-col rounded-lg bg-white shadow">
//                     <div className="flex-shrink-0">
//                         <img className="h-48 w-full object-cover" src={event.photo} alt={event.title} />
//                     </div>
//                     <div className="flex flex-1 flex-col justify-between p-6">
//                         <div className="flex-1">
//                             <p className="text-sm font-medium text-gray-900">{event.title}</p>
//                             <p className="mt-3 text-sm text-gray-500">{event.dateTime}</p>
//                             <p className="mt-3 text-sm text-gray-500">{event.status}</p>
//                         </div>
//                     </div>
//                 </li>
//             ))}
